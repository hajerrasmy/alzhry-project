...
const sections: InfoSectionProps[] = [
  {
    title: "رؤيتنا",
    items: [
      "رؤيتنا هي تحسين خدماتنا وتقديم أفضل الخدمات لعملائنا."
    ]
  },

  {
    title: "أهدافنا",
    items: [
      "هدفنا هو مساعدتك في تلبية جميع متطلباتك الأمنية." , 
      "نحن نقدم مجموعة شاملة من الخدمات الأمنية التي يقدمها بعض من أفضل العاملين في هذا المجال."
    ]
  },
